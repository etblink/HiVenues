...
test('all retained trigger families and exact classifier inputs qualify isolated changes', async (t) => {
  ...
  const examples = [
    ...
    'src/venue/v2/authoring-transaction.js', 'src/venue/v2/studio-authoring.js',
    'test/support/v2-authoring-studio-fixture.js',
    'test/venue-v2-authoring-transaction.test.js', 'test/venue-v2-authoring-studio.test.js',
