...
function restaurantDiningSvg() {
  ...
  <defs>
    <linearGradient id="sky" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#f0b37d"/><stop offset=".55" stop-color="#d5795f"/><stop offset="1" stop-color="#536f89"/></linearGradient>
    <linearGradient id="room" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#5b3a2d"/><stop offset="1" stop-color="#211a16"/></linearGradient>
  </defs>
  <rect x="0" y="0" width="1600" height="600" fill="url(#sky)"/>
  <path d="M0 510 C250 470 390 560 620 515 C900 460 1120 530 1600 440 V620 H0Z" fill="#496678" opacity=".78"/>
  <rect x="0" y="555" width="1600" height="445" fill="url(#room)"/>
  <g fill="#15110f" stroke="#d7b887" stroke-width="8">
    <path d="M210 0v250M800 0v245M1390 0v250"/>
    <circle cx="210" cy="292" r="56"/><circle cx="800" cy="285" r="56"/><circle cx="1390" cy="292" r="56"/>
  </g>
  <g fill="#f8e8cd" opacity=".95">
    <ellipse cx="420" cy="760" rx="250" ry="70"/><ellipse cx="1120" cy="770" rx="270" ry="75"/>
  </g>
  <g fill="#3d291f">
    <rect x="380" y="760" width="80" height="190" rx="18"/><rect x="1080" y="770" width="80" height="180" rx="18"/>
    <rect x="180" y="720" width="80" height="220" rx="24"/><rect x="590" y="720" width="80" height="220" rx="24"/>
    <rect x="860" y="730" width="80" height="210" rx="24"/><rect x="1320" y="730" width="80" height="210" rx="24"/>
  </g>
  <g fill="#fff5e6">
    <circle cx="360" cy="730" r="18"/><circle cx="480" cy="735" r="18"/><circle cx="1060" cy="740" r="18"/><circle cx="1180" cy="744" r="18"/>
  </g>
  <rect x="80" y="80" width="1440" height="650" fill="none" stroke="#f2d9bd" stroke-width="18" opacity=".25"/>`, '#a76e43');
}

function restaurantPrivateSvg() {
  return svgArtwork(1200, 900, 'Private dining room with long table', `
  <defs><linearGradient id="wall" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#ead9c6"/><stop offset="1" stop-color="#b99573"/></linearGradient></defs>
  <rect width="1200" height="900" fill="url(#wall)"/>
  <rect x="85" y="110" width="1030" height="500" rx="18" fill="#faf3ea" opacity=".46"/>
  <rect x="160" y="540" width="880" height="115" rx="54" fill="#5c3d2d"/>
  <rect x="220" y="640" width="65" height="190" rx="20" fill="#4b3428"/><rect x="915" y="640" width="65" height="190" rx="20" fill="#4b3428"/>
  <g fill="#6b3b13"><circle cx="300" cy="520" r="16"/><circle cx="480" cy="520" r="16"/><circle cx="660" cy="520" r="16"/><circle cx="840" cy="520" r="16"/></g>
  <g fill="none" stroke="#6b3b13" stroke-width="12"><path d="M260 250c80-95 160-95 240 0"/><path d="M700 250c80-95 160-95 240 0"/></g>
  <g fill="#fff3d2"><circle cx="380" cy="255" r="24"/><circle cx="820" cy="255" r="24"/></g>`, '#d7c2a9');
}

function restaurantPlateSvg() {
  return svgArtwork(1200, 900, 'Seasonal plated dish on stoneware', `
  <defs><radialGradient id="plate" cx=".5" cy=".45" r=".55"><stop offset="0" stop-color="#fbfaf5"/><stop offset=".72" stop-color="#e4e0d5"/><stop offset="1" stop-color="#bbb7ac"/></radialGradient></defs>
  <rect width="1200" height="900" fill="#6d7462"/>
  <circle cx="600" cy="450" r="335" fill="#4f5549" opacity=".35"/>
  <circle cx="600" cy="430" r="285" fill="url(#plate)"/>
  <ellipse cx="560" cy="420" rx="145" ry="88" fill="#c86f48" transform="rotate(-12 560 420)"/>
  <path d="M500 505c120-85 205-95 290-28" fill="none" stroke="#6a7f3e" stroke-width="38" stroke-linecap="round"/>
  <g fill="#f4d68b"><circle cx="455" cy="390" r="28"/><circle cx="710" cy="360" r="24"/><circle cx="735" cy="500" r="20"/></g>
  <g fill="#8e3e2d"><circle cx="520" cy="340" r="18"/><circle cx="650" cy="530" r="16"/></g>`, '#6d7462');
}
