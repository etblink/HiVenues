...
const compositionRegistry = Object.freeze({
  poster: Object.freeze({
    id: 'poster',
    label: 'Poster room',
    publicTemplate: 'studio/compositions/poster',
    activityTemplate: 'studio/compositions/poster-activity',
  ...
  editorial: Object.freeze({
    ...
    publicTemplate: 'studio/compositions/editorial',
    activityTemplate: 'studio/compositions/editorial-activity',
  ...
  hospitality: Object.freeze({
    ...
    publicTemplate: 'studio/compositions/hospitality',
    activityTemplate: 'studio/compositions/hospitality-activity',
...
function renderIcs(graph, activity) {
  ...
  return [
    ...
    `URL:/studio/${escapeIcs(graph.identity.slug)}/activities/${escapeIcs(activity.slug)}`,
    'END:VEVENT',
    'END:VCALENDAR',
    '',
  ].join('\r\n');
