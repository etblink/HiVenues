...
.preview-meta{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:9px 13px;border-top:1px solid #cbd3d6;background:#fff;color:#627176;font-size:.68rem}.preview-meta strong{color:#243236}
.inspector-summary{padding:15px;border-bottom:1px solid #e1e6e8}.inspector-summary h2{margin:3px 0;font-size:1.15rem}.inspector-summary>p:last-of-type{margin:0;color:#657176;font-size:.76rem}.recipe-chip,.ownership-chip{display:inline-flex;margin-top:7px;padding:4px 7px;border-radius:999px;background:#edf2f2;color:#395255;font-size:.62rem;font-weight:800}.inspector-section{padding:13px 14px;border-bottom:1px solid #e5e9ea}.inspector-section h3{margin:0 0 9px;font-size:.78rem}.inspector-section p{margin:5px 0;color:#435258;font-size:.78rem;line-height:1.5}.inspector-section>small{color:#6e7a7e;font-size:.65rem}.inspector-fields{padding:0}.inspector-field{display:flex;align-items:center;justify-content:space-between;gap:7px;padding:9px;border-radius:8px}.inspector-field strong,.inspector-field small{display:block}.inspector-field strong{font-size:.73rem}.inspector-field small{margin-top:2px;color:#6d797d;font-size:.63rem;overflow-wrap:anywhere}.inspector-field.is-selected{background:#eaf5f2}.inspector-field .ownership-chip{margin:0;white-space:nowrap}.selected-field{background:#f3faf7;border-left:4px solid #176b61}
dl{margin:0;display:grid;grid-template-columns:minmax(90px,.7fr) minmax(0,1.3fr);gap:6px 10px}dt{color:#6f7a7e;font-size:.65rem}dd{margin:0;font-size:.7rem;overflow-wrap:anywhere}dd span{display:block;color:#748084;font-size:.61rem;font-weight:400}.diagnostics{margin:10px;border:1px solid #d9e0e2;border-radius:9px}.diagnostics summary{display:flex;align-items:center;padding:9px 10px;cursor:pointer;font-size:.7rem;font-weight:800}.diagnostics dl{padding:0 10px 10px}
.read-only-note{margin:0;padding:9px 14px;border-top:1px solid #dbe2e4;background:#f7faf9;color:#5d696d;font-size:.67rem}
