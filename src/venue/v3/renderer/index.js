...
function renderV3PublicStylesheet() {
  return `
*{box-sizing:border-box}:root{--v3-site-width:72rem;--v3-reading-width:46rem;--v3-space-section:clamp(3rem,7vw,6.5rem)}html{background:var(--v3-canvas);color:var(--v3-text);font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;font-size:16px}body{margin:0;line-height:1.65;letter-spacing:.005em}body::before{content:"";display:block;height:.25rem;background:var(--v3-accent)}a{color:inherit;text-decoration-thickness:.08em;text-underline-offset:.18em}h1,h2,h3{margin-top:0;font-family:ui-serif,Georgia,Cambria,"Times New Roman",serif;font-weight:650;line-height:1.05;letter-spacing:-.025em;text-wrap:balance}p{max-width:68ch}.v3-site-header{width:min(var(--v3-site-width),calc(100% - 3rem));margin:0 auto;display:flex;gap:2rem;align-items:center;justify-content:space-between;padding:1.4rem 0;border-bottom:1px solid var(--v3-border)}.v3-wordmark{font-size:1.1rem;font-weight:800;letter-spacing:-.015em;text-decoration:none}.v3-primary-nav{display:flex;gap:clamp(.9rem,2.5vw,1.75rem);align-items:center;flex-wrap:wrap}.v3-primary-nav a,.v3-action{display:inline-flex;align-items:center;min-height:44px}.v3-primary-nav a{padding:.45rem .1rem;font-size:.92rem;font-weight:650;text-decoration-color:transparent;text-underline-offset:.35rem}.v3-primary-nav a:hover{text-decoration-color:currentColor}.v3-action{padding:.62rem .9rem;border-radius:.55rem}.v3-action--primary{background:var(--v3-accent);color:var(--v3-accent-text);text-decoration:none}.v3-action--secondary{border:1px solid var(--v3-border);text-decoration:none}.v3-page,.v3-activity-detail{width:min(var(--v3-site-width),calc(100% - 3rem));margin:0 auto;padding:0 0 5rem}.v3-page-heading{max-width:var(--v3-reading-width);padding:clamp(3rem,8vw,6.5rem) 0 clamp(1.25rem,3vw,2.25rem)}.v3-page-heading h1,.v3-activity-detail>article>header h1{font-size:clamp(2.7rem,7vw,5.6rem);max-width:12ch;margin-bottom:0}.v3-component{margin:var(--v3-space-section) 0;padding:0;background:transparent}.v3-narrative{max-width:var(--v3-reading-width)}.v3-component h2,.v3-activity-detail h2{font-size:clamp(2rem,4vw,3.4rem);max-width:18ch;margin-bottom:1rem}.v3-component h3{font-size:clamp(1.45rem,2.5vw,2rem);margin-bottom:.7rem}.v3-activity-detail article{margin:0;padding:clamp(3rem,7vw,6rem) 0;background:transparent}.v3-activity-list__items{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,20rem),1fr));gap:0;border-top:1px solid var(--v3-border)}.v3-activity-card{padding:1.5rem 0;border-bottom:1px solid var(--v3-border)}.v3-activity-card h3 a{text-decoration-color:transparent}.v3-activity-card h3 a:hover{text-decoration-color:currentColor}.v3-media,.v3-activity-media{margin:0}.v3-media img,.v3-activity-media img{display:block;max-width:100%;height:auto}.v3-kicker,.v3-eyebrow{margin:0 0 .7rem;color:var(--v3-muted);font-size:.78rem;font-weight:800;letter-spacing:.13em;text-transform:uppercase}.v3-note{color:var(--v3-muted);font-size:.95rem}.v3-status{color:var(--v3-muted);font-size:.82rem;font-weight:750;letter-spacing:.08em;text-transform:uppercase}.v3-status--important{color:var(--v3-text);font-weight:900}.v3-activity-presence,.v3-visit-facts{margin:1.5rem 0}.v3-visit-facts{max-width:var(--v3-reading-width);padding-top:1.5rem;border-top:1px solid var(--v3-border)}.v3-primary-nav a:focus-visible,.v3-action:focus-visible,.v3-wordmark:focus-visible,.v3-activity-card a:focus-visible{outline:3px solid var(--v3-focus);outline-offset:4px}.v3-primary-nav a,.v3-activity-card a{transition:text-decoration-color .16s ease}.v3-action{transition:transform .16s ease,box-shadow .16s ease}.v3-action:hover{transform:translateY(-1px)}@media (max-width:640px){.v3-site-header{width:calc(100% - 2rem);align-items:flex-start;flex-direction:column;gap:.35rem;padding:1rem 0}.v3-primary-nav{width:100%;gap:.8rem 1.15rem;overflow-wrap:anywhere}.v3-page,.v3-activity-detail{width:calc(100% - 2rem);padding-bottom:3rem}.v3-page-heading{padding:2.75rem 0 1rem}.v3-page-heading h1,.v3-activity-detail>article>header h1{font-size:clamp(2.4rem,13vw,4rem)}.v3-component{margin:3rem 0}.v3-activity-detail article{padding:2.75rem 0}.v3-activity-list__items{grid-template-columns:1fr}}@media (prefers-reduced-motion:reduce){*,*::before,*::after{scroll-behavior:auto!important;transition-duration:.01ms!important;animation-duration:.01ms!important;animation-iteration-count:1!important}}
`.trim();
}
