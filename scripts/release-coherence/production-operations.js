...
function assertProductionOperationsCompatibility({ operations }) {
  ...
  requireMatch(operations, /canonical-source beta manifest: `post`, `comment`, `vote`, `follow`, `unfollow`, `subscribe`, `unsubscribe`, `profile`, `claim-rewards`, `wall`, `inbox`, `thread`/, 'operations must preserve the exact canonical-source beta manifest including profile');
