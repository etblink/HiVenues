...
const visualPatterns = [
  ...
  'test/support/v2-renderer-fixture.js',
  'test/support/v2-studio-fixture.js',
  'test/venue-v2-read-only-studio.test.js',
  'test/venue-v2-renderer.test.js',
  'src/venue/read-only-venue-canvas-surface.js',
  'src/venue/canvas-source-preview.js',
  'src/venue/v2/renderer/*',
  ...
  'test/venue-v2-menu-scalar.test.js',
